...
public abstract class Document {
	...
	{   
		text = text.toLowerCase(); //format string to all lower case
	...
	protected int countSyllables(String word)
	{
		...
		//method using Matcher object
		/*
		ArrayList<String> tokens = new ArrayList<String>();
		word = word.toLowerCase();
		Pattern tokSplitter = Pattern.compile("[bcdfghjklmnpqrstvwxz]*[aoeuiy]+[bcdfghjklmnpqrstvwxz]*");
		Matcher m = tokSplitter.matcher(word);
		while (m.find()) {
			tokens.add(m.group());
		}
		int numTokens = tokens.size();
		//exclude alone "e" at the end of a word 
